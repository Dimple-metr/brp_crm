			...
			<form class="form-horizontal" role="form" id="consignee_add" action="javascript:;" method="post" name="consignee_add">
				...
				<div class="col-md-4">
					...
					<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Select Country *</label>
						<div class="col-md-10 col-xs-11">
							<select class="select2" name="countryid" id="countryid" onChange="load_state(this.value,'con_stateid','')">
				...
				<div class="col-md-4">
					...
					<label class="col-md-12 control-label" style="text-align:left;line-height:25px">Select State *</label>
						<div class="col-md-10 col-xs-11">
							<select class="select2" name="stateid" id="con_stateid" onChange="load_city(this.value,'con_cityid','')">
								<?=getstate($dbcon,$stateid)?>			
							</select>
						</div>
