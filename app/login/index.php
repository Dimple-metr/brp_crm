		...
		if(isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == $d)
		{
			...
			if(isset($is_ajax) && $is_ajax)
			{
				...
				if($_POST['token'] == $_SESSION['token'])
				{
					...
					$sql = "SELECT `user_id`, `branch_id`, `user_name`, `user_mail`,`user_type`, `user_phone`, `user_company`, `user_country`,`user_stat`, `user_tmst`,`user_date`,`setup`,`payment_status`,datediff (CURDATE(),user_tmst) as datedif,print_align FROM `users` WHERE `user_mail` = '$usr' AND `user_key` = '$pwd'";
