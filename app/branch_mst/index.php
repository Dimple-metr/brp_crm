...
if($_POST != NULL) {
	...
	if(strtolower($POST['mode']) == "fetch") {
		...
		foreach($sqlReturn as $row) {
			...
			$pro_stck_btn='<a class="btn btn-xs btn-info" data-original-title="Add Branch Opening Stock" data-toggle="tooltip" data-placement="top" href="'.ROOT.'branch_product_stock/'.$row['branch_id'].'"><i class="fa fa-plus"></i></a>';
