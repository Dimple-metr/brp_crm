				  ...
				  <header class="panel-heading">
					...
					<div class="panel-body">
						<form role="form" id="menu_add" action="javascript:;" method="post" name="menu_add">
							  ...
							  <div class="form-group">
								  <label for="vendor_name">Select Module</label>
								  <select class="select2" name="menu_module" id="menu_module">
									<option value="">--Select Module--</option>
									<?=get_all_module($dbcon);?>
								  </select>
							  </div>							  
							  <div class="form-group">
		...
		<div class="modal-content">
			...
			<form id="FormEditMenu" role="form" method="post" novalidate>				
				...
				<div class="form-group">
					...
					<select class="select2" name="menu_module" id="edit_menu_module">
						<option value="">--Select Module--</option>
						<?=get_all_module($dbcon);?>
					</select>
				</div>				
