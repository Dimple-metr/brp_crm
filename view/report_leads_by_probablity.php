<?php 
	...
	$form="Leads by Leads by Probablity Report";
?>
...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.'report_leads_by_probablity'?>"><?=$form?></a></li>
									</ul>
								</div>
							</section>
						</div>	
		...
		<script src="<?=ROOT?>js/app/report_leads_by_probablity.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
