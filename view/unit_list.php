					...
					<div class="panel-body">
						<form role="form" id="unit_add" action="javascript:;" method="post" name="unit_add">
								<div class="form-group">
								 ...
								 <input class="form-control" type='text' name='unit_name' id='unit_name' value='' />
							    </div>
...
<div class="modal colored-header info" id="ModalEditAccount" role="dialog" data-keyboard="false" data-backdrop="static">
	<div class="modal-dialog custom-width">
		<div class="modal-content">
			...
			<form id="FormEditunit" role="form" method="post" novalidate><div class="form-group">
	...
	<script src="<?=ROOT?>js/app/unit_mst.js?<?=time()?>"></script>
<script>
$(".select2").select2({
		width: '100%'
	});
