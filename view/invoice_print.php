<?php 
	...
	$query="select inv.*,ven.cust_name,ven.cust_gst,so.sales_order_no from tbl_invoice as inv 
		inner join tbl_customer as ven on ven.cust_id=inv.cust_id
		left join tbl_sales_order as so on so.sales_order_id=inv.sales_order_id
	...
	$tax_types_qry="select sum(tax_amount2) as tax2_amt from tbl_invoice_trn where invoice_trn_status=0 and invoice_id=".$rel['invoice_id'];
...
<input type="hidden" name="typename" id="typename" value="<?=$rel['invoice_type']?>">
		...
		<tr>
			<th colspan="11" style="padding:0px !important;">
				<table style="font-size:12px;border-collapse: collapse;border-top:none;" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td width="20%" style="vertical-align:top;border:1px solid;border-right:none;">Invoice No 
							</td>
							<td width="30%" style="vertical-align:top;border:1px solid;border-left:none;"> : <strong><?=$rel['invoice_no']?></strong>
							</td>
							<td width="20%" style="vertical-align:top;border:1px solid;border-right:none;">Invoice Date 
							</td>
							<td width="30%" style="vertical-align:top;border:1px solid;border-left:none;"> : <strong><?=date('d-m-Y',strtotime($rel['invoice_date']))?></strong>
							</td>
						</tr>
						<tr>
							<td style="vertical-align:top;border:1px solid;border-right:none;">Challan No 
							</td>
							<td style="vertical-align:top;border:1px solid;border-left:none;"> : <strong><?=$rel['challan_no']?></strong>
							</td>
							<td style="vertical-align:top;border:1px solid;border-right:none;">Challan Date 
							</td>
							<td style="vertical-align:top;border:1px solid;border-left:none;"> : <strong><?=date('d-m-Y',strtotime($rel['challan_date']))?></strong>
							</td>
						</tr> 
						<tr>
							<td colspan="2" style="vertical-align:top;border:1px solid;">
								Bill To,<br/>
								<?=$rel['cust_name']?><br/>
								<span style="font-weight:normal;"><?=nl2br($rel['inv_cust_address'])?></span>
								<br/>GST NO : <?=$rel['cust_gst']?>
							</td>
							<td colspan="2" style="vertical-align:top;border:1px solid;">
								Ship To,<br/>
								<span style="font-weight:normal;"><?=nl2br($rel['inv_ship_address'])?></span>
							</td>
						</tr> 
				</table>
	...
	<tbody style="border: 1px solid;">
		<? 
			$qry="select trn.*,product.product_name,product.product_hsn,unit_name,group_concat(tax.tax_value) as tax_val,group_concat(tax.tax_name) as tax_name FROM `tbl_invoice_trn` as trn 
			...
			where invoice_trn_status=0 and invoice_id=".$rel['invoice_id']." group by invoice_trn_id order by invoice_trn_id";
		...
		<?  } ?>
			...
			<tr>
				...
				<? $r=round($total)-$total; ?>
					...
					<tr height="35px">
						<td colspan="<?=(($colspan)+5)?>" style="border:1px solid;border-left:none;"></td>
					</tr>
					<tr>
						<td colspan="<?=(($colspan)+5)?>" style="font-size:10px;padding:0px !important;" >
							<table border="0" style="font-size:10px;text-align:right;border-collapse:collapse;" width="100%">
								<tr>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;"><strong>HSN Code</strong></td>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>Total Amt.</strong></td>
									
								<?	if($tax_types=='1') {?>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>CGST %</strong></td>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>CGST Amt.</strong></td>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>SGST %</strong></td>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>SGST Amt.</strong></td>
								<?	}
									else{ ?>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>IGST %</strong></td>
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;border-right:1px solid;" ><strong>IGST Amt.</strong></td>
								<?	}?>
									
									<td style="vertical-align:top;text-align:center;border-bottom:1px solid;"><strong>Total Tax Amount<strong></td>
								</tr>
						<?
							$query="select sum(product_total) as amount,sum(tax_amount1) as tax_amt1,product.product_hsn,sum(tax_amount2) as tax_amt2,tax_name1,tax_name2 
								FROM `tbl_invoice_trn` as trn 
								left join tbl_product as product on product.product_id=trn.product_id 
								where invoice_trn_status=0 and invoice_id=".$rel['invoice_id']." group by trn.formulaid, trn.product_hsn_code";
						...
						<?	if($tax_types=='1') { ?>
							...
							<?	}?>
								<td style="vertical-align:top;text-align:right;border-bottom:1px solid;" >
						...
						?>		
							<tr>
								...
								<td style="vertical-align:top;text-align:right;border:1px solid;" >
							...
							<?	}?>
								<td style="vertical-align:top;text-align:right;border:1px solid;"><?=number_format($total1,2)?></td>
							</tr>
							</table>
						</td>
					</tr>
					<tr height="35px">
						<td colspan="<?=(($colspan)+5)?>" style=""></td>
					</tr>
					<tr>
						<td colspan="<?=$colspan?>" style="vertical-align:top;font-size:10px;text-align:left;" class="con">
