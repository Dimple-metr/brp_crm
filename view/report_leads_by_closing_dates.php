<?php 
	...
	$form="Leads by Closing Dates Report";
...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.'report_leads_by_closing_dates'?>"><?=$form?></a></li>
									</ul>
								</div>
							</section>
						</div>	
								...
								<div class="panel-body">
									<div class="col-md-12">
										...
										<div class="col-md-4" >
											...
											<div class="col-md-8">
												<input id="start_date" name="start_date" type="text" class="form-control default-date-picker reuired valid" title="Date" value="<?=$start_date?>" placeholder="Start Date">
											</div>
										</div>
										<div class="col-md-4" >
											<div class="col-md-4"><strong>End Date</strong></div>
											<div class="col-md-8">
												<input id="end_date" name="end_date" type="text" class="form-control default-date-picker reuired valid" title="Date" value="<?=$end_date?>" placeholder="End Date">
											</div>
										</div>
										<div class="col-md-4" >
											<button type="button" id="addcust" onclick="load_ledger_datatable();" class="btn btn-primary">Show Report</button>
										</div>
		...
		<script src="<?=ROOT?>js/app/report_leads_by_closing_dates.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
