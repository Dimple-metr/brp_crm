		...
		<center>
			<div class="col-md-1"> </div>
				...
				<div class="col-md-4 text-left">
					...
					<a href="<?=ROOT.'prf_list'?>" type="button" class="btn btn-danger"><i class="fa fa-ban"></i> Cancel</a>
...
<table width="100%" class="maintable" style="font-size: 12px;" id="invoice_type" >
		...
		<tr>
			<th colspan="5" style="padding:0px !important;">
				<table  border="0" style="font-size:12px;border-collapse:collapse;" cellpadding="0"  cellspacing="0" width="100%" id="">
					<!--<thead>-->
						<tr>
							<td width="10%" style="vertical-align:top;border:1px solid;border-right:none;"><strong>PRF Entry No </strong>
							</td>
							 
							<td style="vertical-align:top;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">: <strong> <?=$rel['prf_entry_no']?></strong>
							</td>
	...
	<tbody style="border: 1px solid;">
		<? 
			 $qry="select trn.*,product.product_name FROM `tbl_prf_ven_rmrk` as trn
			left join tbl_product as product on product.product_id=trn.product_id
			where ven_rmrk_status=0 and prf_entry_id=".$rel['prf_entry_id'];
