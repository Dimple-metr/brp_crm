...
<html lang="en">
	...
	<body>
							...
							<section class="panel">
								...
								<div class="">
									<ul class="breadcrumb">
										...
										<li ><a href="<?=ROOT.'report_new_vs_existing'?>"><?=$form?></a></li>
									</ul>
								</div>
							</section>
						</div>	
							...
							<section class="panel">
								...
								<div class="panel-body">
									<div class="col-md-12">
										...
										<div class="col-md-4" >
											<div class="col-md-4"><strong>Inquiry Type</strong></div>
											<div class="col-md-8">
		...
		<script src="<?=ROOT?>js/app/report_new_vs_existing.js?<?=time()?>"></script>
		<script>
			$(".select2").select2({
				width: '100%'
			});
